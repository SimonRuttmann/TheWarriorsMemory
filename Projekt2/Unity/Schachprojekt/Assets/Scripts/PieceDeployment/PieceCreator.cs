...
namespace Scripts.PieceDeployment
{
    ...
    public class PieceCreator : MonoBehaviour
    {
        ...
        /// <summary>
        /// All prefabs of the pieces will be added to this array 
        /// </summary>
        ...
        /// </summary>
        private Dictionary<string, GameObject> _pieceTypeModels;
    
    
        private void Awake()
        {
            if (_pieceTypeModels != null) return;
        
            _pieceTypeModels = new Dictionary<string, GameObject>();
            AddModelsToDictionary();
        }
    
    
        private void AddModelsToDictionary()
        {
