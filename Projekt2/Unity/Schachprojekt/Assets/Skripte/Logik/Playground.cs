...
public class Playground : MonoBehaviour
{
    ...
    private void StartKonflikt(Piece angreifendePiece, Piece geschlagenePiece, Vector2Int kooridanten)
    {
        ...
        //Bewegung Angreifer
        animationManager.DreheFigur1(0f, angreifendePiece, (float)RotationspunktAngreifer);

        //Bewegung Verteidiger
        animationManager.DreheFigur2(0f, geschlagenePiece, (float)RotationspunktVerteidiger);

        //Angriff
        animationManager.StartAnimation(1f, angreifendePiece, null, AnimationManager.Animationtrigger.Angriff);

        //Sterben
        animationManager.StartAnimation(1.5f, null, geschlagenePiece, AnimationManager.Animationtrigger.Sterben);

        //Loeschen
        animationManager.StartAnimation(4f, null, geschlagenePiece, AnimationManager.Animationtrigger.Loeschen);

        //Bewege Figur 1 auf Figur 2
        animationManager.BewegeFigur(5f, angreifendePiece, kooridanten);

        //Drehe Figur zurück
        int back = 0;
        if (angreifendePiece.Team == Team.Player) back = 180;

        animationManager.DreheFigur1(6f, angreifendePiece, (float)back);
    ...
    public void BefoerdereFigur(Piece piece)
    {
        ...
        
        SchlageFigur(piece);
        animationManager.SauberesLoeschen(1, piece);
    ...
    {
        animationManager.StartEndAnimation(1.5f, geschlagenePiece);
